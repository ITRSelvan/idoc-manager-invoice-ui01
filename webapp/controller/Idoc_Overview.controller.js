...
//         return Controller.extend("com.idocmanagerinvoiceui01.controller.Idoc_Overview", {
//             onInit: function () {
...
sap.ui.define(
    [
      "com/idocmanagerinvoiceui01/controller/BaseController",
      ...
      // eslint-disable-next-line @sap/ui5-jsdocs/check-jsdoc-param-type
      "sap/m/MessageBox",
      "com/idocmanagerinvoiceui01/lib/RestService",
      // eslint-disable-next-line @sap/ui5-jsdocs/check-jsdoc-param-type
      "sap/ui/model/Filter",
      // eslint-disable-next-line @sap/ui5-jsdocs/check-jsdoc-param-type
    ...
    /**
     *
     * @param {com.idocmanagerinvoiceui01.controller.BaseController} BaseController Base Controller
     ...
     * @param {com.idocmanagerinvoiceui01.lib.RestService} Rest Rest Service
     ...
     * @returns {com.idocmanagerinvoiceui01.controller.BaseController} Controller
     */
    function (
      BaseController,
      JSONModel,
      ...
      return BaseController.extend(
        "com.idocmanagerinvoiceui01.controller.Idoc_Overview",
        {
          onInit: function () {
          ...
          onWorkflowButtonClick: function () {
            ...
            if (!this.byId("processDialog")) {
              ...
              Fragment.load({
                ...
                name: "com.idocmanagerinvoiceui01.view.fragment.Workflow",
          ...
          showWorkflowResultDialog: function () {
            ...
            if (!this.byId("workflowRsltDialog")) {
              ...
              Fragment.load({
                id: that.getView().getId(),
                name: "com.idocmanagerinvoiceui01.view.fragment.WorkflowResult",
                controller: oFragmentController,
              }).then(function (oDialog) {
                // connect dialog to the root view of this component (models, lifecycle)
                that.getView().addDependent(oDialog);
          ...
          showProcessResultDialog: function () {
            ...
            if (!this.byId("processRsltDialog")) {
              ...
              Fragment.load({
                id: that.getView().getId(),
                name: "com.idocmanagerinvoiceui01.view.fragment.ProcessResult",
                controller: oFragmentController,
              }).then(function (oDialog) {
                // connect dialog to the root view of this component (models, lifecycle)
                that.getView().addDependent(oDialog);
