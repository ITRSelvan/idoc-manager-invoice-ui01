		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "IDoc Manager Invoice",
									"targetURL": "#comidocmanagerinvoiceui01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comidocmanagerinvoiceui01-display": {
								"semanticObject": "comidocmanagerinvoiceui01",
								"action": "display",
								"description": "A Bas Fiori application.",
								"title": "IDoc Manager Invoice",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.idocmanagerinvoiceui01",
									"url": sap.ui.require.toUrl("com/idocmanagerinvoiceui01")
								}
							}
						}
					}
